export default {
  ...
  nav: {
    ...
    ops: 'Ops',
    requestTranscripts: 'Request Audit',
  ...
  admin: {
    ...
    users: {
      ...
      manageAsUser: 'Enter User Account',
      failedToImpersonate: 'Failed to switch to user account',
      groups: 'Groups',
      apiKeys: 'API Keys',
    ...
    ops: {
      ...
      requestTranscripts: {
        title: 'Request Audit',
        description: 'Inspect successful request input text and model output text excerpts.',
        listTitle: 'Audit Records',
        total: '{total} records',
        empty: 'No audit records yet',
        emptyHint: 'Send a successful request first, then come back here.',
        noSelection: 'Select a record on the left to view details.',
        failedToLoad: 'Failed to load request audit records',
        requestIdCopied: 'Request ID copied',
        requestTextCopied: 'Request text copied',
        responseTextCopied: 'Response text copied',
        copyRequestId: 'Copy ID',
        copyRequestText: 'Copy Input',
        copyResponseText: 'Copy Output',
        filters: {
          timeRange: 'Time Range',
          requestId: 'Request ID',
          requestIdPlaceholder: 'Exact request_id match',
          clientRequestId: 'Client Request ID',
          clientRequestIdPlaceholder: 'Exact client_request_id match',
          userId: 'User ID',
          userIdPlaceholder: 'Select a user',
          userSearchPlaceholder: 'Search user email',
          accountId: 'Account ID',
          accountIdPlaceholder: 'e.g. 366',
          model: 'Model',
        ...
        detail: {
          ...
          upstreamEndpoint: 'Upstream Endpoint',
          upstreamModel: 'Upstream Model',
          requestText: 'User Input',
          responseText: 'Model Output',
          requestTextTruncated: 'Input text is truncated for display',
          responseTextTruncated: 'Output text is truncated for display'
        }
      },
      alertEvents: {
        title: 'Alert Events',
