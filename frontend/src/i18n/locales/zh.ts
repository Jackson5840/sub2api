export default {
  ...
  admin: {
    ...
    ops: {
      ...
      requestTranscripts: {
        title: '请求审计',
        description: '查看成功请求中用户输入的文本与模型返回的文本摘要。',
        listTitle: '审计记录',
        total: '共 {total} 条',
        empty: '暂无审计记录',
        emptyHint: '先发起一次成功请求，再回到这里查看。',
        noSelection: '请选择左侧一条记录查看详情。',
        failedToLoad: '加载请求审计失败',
        requestIdCopied: '请求 ID 已复制',
        requestTextCopied: '请求文本已复制',
        responseTextCopied: '响应文本已复制',
        copyRequestId: '复制 ID',
        copyRequestText: '复制输入',
        copyResponseText: '复制输出',
        filters: {
          timeRange: '时间范围',
          requestId: '请求 ID',
          requestIdPlaceholder: '精确匹配 request_id',
          clientRequestId: '客户端请求 ID',
          clientRequestIdPlaceholder: '精确匹配 client_request_id',
          userId: '用户 ID',
          userIdPlaceholder: '选择用户',
          userSearchPlaceholder: '搜索用户邮箱',
          accountId: '账号 ID',
          accountIdPlaceholder: '例如 366',
          model: '模型',
        ...
        detail: {
          ...
          requestText: '用户输入',
          responseText: '模型输出',
          requestTextTruncated: '输入文本已截断显示',
          responseTextTruncated: '输出文本已截断显示'
        }
      },
      alertEvents: {
        title: '告警事件',
